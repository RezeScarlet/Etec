		...
		<div class="row">
			<div class="col">
				<form action="#" method="POST">
					...
					<div class="mt-3 form-group">
						<label>
							<p class="fs-3 m-0">Produto:</p>
							<input type="text" id="produto" name="produto" class="form-control" required></input>
						</label>
					</div>

					<div class="btns">
						<input type="submit" value="Enviar" class="btn-lg btn m-2 text-white" style="background: #483fff;">
						<input type="reset" value="Limpar" class="btn-lg btn-secondary btn m-2">
					</div>
			...
			<div class="container col mt-4 table-responsive-sm">
				...
				if ($_POST) {
					...
					$sql = "SELECT * FROM produtos WHERE produto like '%$produto%'";
